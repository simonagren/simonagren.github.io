          ...
          <div id={"social"}>
            ...
            <div className="social-btns">
              <a
                ...
                href="https://twitter.com/agrenpoint"
                target="_blank"
                rel="noopener"
              >
                <FaTwitter />
              ...
              <a
                ...
                href="https://www.linkedin.com/in/simonaagren"
                target="_blank"
                rel="noopener"
              >
                <FaLinkedin />
              ...
              <a
                ...
                href="https://github.com/simonagren"
                target="_blank"
                rel="noopener"
              >
                <FaGithub />
              </a>
              <a className="btn rss" href="/rss">
                <FaRssSquare />
              </a>
            </div>
            <style jsx>{`
              ...
              .social-btns .btn {
                ...
                position: relative;
                overflow: hidden;
                -webkit-box-shadow: 0 0 3px 1px rgba(95, 93, 138, 0.15);
                box-shadow: 0 0 3px 1px rgba(95, 93, 138, 0.15);
                opacity: 0.99;
                padding: 0;
              }
